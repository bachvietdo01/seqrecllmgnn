...
python mainmn.py --nproc_per_node="${NPROC_PER_NODE}" --nnodes="${NNODES}" --rdzv_id="$SLURM_JOB_ID" --rdzv_endpoint="${MASTER_ADDR}:${MASTER_PORT}" --config_file IDNet/srgnnseqllm.yaml overall/ID.yaml
